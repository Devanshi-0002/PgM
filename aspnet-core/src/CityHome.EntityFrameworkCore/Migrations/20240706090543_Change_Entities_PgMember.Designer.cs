...
namespace CityHome.Migrations
{
    ...
    [Migration("20240706090543_Change_Entities_PgMember")]
    partial class Change_Entities_PgMember
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("CityHome.PgMembers.PgMember", b =>
                {
                    ...
                    b.Property<string>("JobCollegeAddress")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("CityHome.Addresses.Address", b =>
                {
                    b.HasOne("CityHome.PgMembers.PgMember", "PgMember")
                        .WithOne("Address")
                        .HasForeignKey("CityHome.Addresses.Address", "PgMemberId")
