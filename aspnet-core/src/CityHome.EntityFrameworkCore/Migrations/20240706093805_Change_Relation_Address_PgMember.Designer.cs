...
{
    [DbContext(typeof(CityHomeDbContext))]
    [Migration("20240706093805_Change_Relation_Address_PgMember")]
    partial class Change_Relation_Address_PgMember
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CityHome.Addresses.Address", b =>
                {
                    b.Property<Guid>("Id")
                    ...
                    b.Property<Guid?>("PgMemberId")
                        .HasColumnType("uniqueidentifier");

                    b.Property<Guid?>("PgMemberId1")
                        .HasColumnType("uniqueidentifier");

                    b.Property<Guid?>("PgMemberId2")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("PgMemberId");

                    b.HasIndex("PgMemberId1")
                        .IsUnique()
                        .HasFilter("[PgMemberId1] IS NOT NULL");

                    b.HasIndex("PgMemberId2")
                        .IsUnique()
                        .HasFilter("[PgMemberId2] IS NOT NULL");

                    b.ToTable("Addresses", (string)null);
                });

            modelBuilder.Entity("CityHome.Documents.UserDocument", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("CityHome.PgMembers.PgMember", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<string>("JobCollegeOtherOption")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.ToTable("PgMembers", (string)null);
                });

            modelBuilder.Entity("CityHome.Pgs.Pg", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<DateTime>("PgOpeningDate")
                        .HasColumnType("datetime2");

                    b.Property<decimal>("PgRent")
                        .HasColumnType("decimal(18,2)");
            ...
            modelBuilder.Entity("CityHome.Addresses.Address", b =>
                {
                    b.HasOne("CityHome.PgMembers.PgMember", "PgMember")
                        .WithMany()
                        .HasForeignKey("PgMemberId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("CityHome.PgMembers.PgMember", null)
                        .WithOne("PermanentAddress")
                        .HasForeignKey("CityHome.Addresses.Address", "PgMemberId1");

                    b.HasOne("CityHome.PgMembers.PgMember", null)
                        .WithOne("JobCollegeAddress")
                        .HasForeignKey("CityHome.Addresses.Address", "PgMemberId2");

                    b.Navigation("PgMember");
                });
            ...
            modelBuilder.Entity("CityHome.PgMembers.PgMember", b =>
                {
                    b.Navigation("JobCollegeAddress")
                        .IsRequired();
