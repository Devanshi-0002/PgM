...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CityHome.Data.Pgs", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("PgAddressId");

                    b.ToTable("AppPgs", (string)null);
                });
            ...
            modelBuilder.Entity("CityHome.Documents.UserDocument", b =>
                {
                    ...
                    b.Property<byte[]>("PassportSizePhoto")
                        .IsRequired()
                        .HasColumnType("varbinary(max)");
            ...
            modelBuilder.Entity("CityHome.Data.Pgs", b =>
                {
                    b.HasOne("CityHome.Addresses.Address", "PgAddress")
                        .WithMany()
                        .HasForeignKey("PgAddressId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("PgAddress");
                });

            modelBuilder.Entity("CityHome.Documents.UserDocument", b =>
                {
                    b.HasOne("CityHome.PgMembers.PgMember", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("CityHome.PgMembers.PgMember", b =>
                {
                    b.HasOne("CityHome.Addresses.Address", "JobLocation")
                        .WithMany()
                        .HasForeignKey("JobLocationId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("CityHome.Addresses.Address", "PermanentAddress")
                        .WithMany()
                        .HasForeignKey("PermanentAddressId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("CityHome.Data.Pgs", "Pg")
                        .WithMany()
                        .HasForeignKey("PgId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
